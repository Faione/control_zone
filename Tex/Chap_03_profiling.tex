...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{vm_arch}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{exporters}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\bicaption{\quad 不同应用资源均值的变异系数比较}{\quad Comparison of the CV of the average resource usage for different applications}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\bicaption{\quad Redis与Memcached资源指标的变异系数对比}{\quad Comparison of the CV of resource metric between Redis and Memcached}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\bicaption{\quad Nginx与Kafka资源指标统计值的变异系数对比}{\quad Comparison of the CV of resource metric between Nginx and Kafka}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\bicaption{\quad Elasticsearch与Render资源指标统计值的变异系数对比}{\quad Comparison of the CV of resource metric between Elasticsearch and Render}
