...
\begin{figure}[!htbp]
    ...
    \bicaption{\quad CPU拓扑结构}{\quad CPU topologies}
...
\begin{figure}[!htbp]
    ...
    \bicaption{\quad SMT兄弟核心的片上资源共享 }{\quad On-chip resource sharing of SMT sibling cores}
...
\begin{figure}[!htbp]
    ...
    \bicaption{\quad EEVDF调度器可变时间片机制的作用}{\quad Effectiveness of the EEVDF scheduler's variable time slice mechanism}
...
\begin{itemize}
    ...
    \begin{table}[!htbp]
        \bicaption{\quad 调度域对应的共享资源}{\quad Shared resources corresponding to scheduling domains}% caption
...
\begin{figure}[!htbp]
    ...
    \end{subfigure}
\bicaption{\quad Control Zone与Firecracker的功能差异}{\quad Differences in functionality between Control Zone and Firecracker}
\label{fig:arch_dif}
\end{figure}
