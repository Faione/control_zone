...
Control Zone整体架构如图~\ref{fig:controlzone_arch}所示，其中管理器负责进行Control Zone的管理，提供隔离环境的定制能力，并可根据混部任务的属性动态地对Control Tower调度器进行修改。除此之外，可观测性基础能够与各层次的系统组件交互，以采集全面的虚拟机指标信息。
