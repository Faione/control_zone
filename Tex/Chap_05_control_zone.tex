...
\begin{figure}[!htbp]
    ...
    \bicaption{\quad Control Zone管理器的组件架构}{\quad Component architecture of the Control Zone Manager}
...
\begin{table}[H]
    \bicaption{\quad Control Zone 虚拟机监视器配置}{\quad Control Zone hypervisor configuration}% caption
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.56\textwidth}
        ...
        \label{fig:cz_start}
    \end{subfigure}
\bicaption{\quad Control Zone创建与启动流程设计}{\quad Control Zone creation and startup process design}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.53\textwidth}
        ...
        \label{fig:cz_remove}
    \end{subfigure}
\bicaption{\quad Control Zone关闭与删除流程设计}{\quad Control Zone shutdown and deletion process design}
\label{fig:cz_create_start}
\end{figure}
...
\begin{figure}[H]
    ...
    \bicaption{\quad Control Zone更新流程设计}{\quad Control Zone update process design}
    \label{fig:cz_update}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \end{subfigure}
\bicaption{\quad Control Zone沙箱对不同应用性能的影响}{\quad The impact of the Control Zone sandbox on the performance of different applications}
\label{fig:perf_app}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \bicaption{\quad 混部场景下Control Zone对Memcached服务性能的保障效果}{\quad Effectiveness of Control Zone for Memcached QoS guarantee in co-location deployment scenarios}
