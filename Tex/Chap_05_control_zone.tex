...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.56\textwidth}
        ...
        \label{fig:cz_start}
    \end{subfigure}
\bicaption{\quad Control Zone创建与启动过程设计}{\quad Control Zone creation and startup process design}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.53\textwidth}
        ...
        \label{fig:cz_remove}
    \end{subfigure}
\bicaption{\quad Control Zone关闭与删除过程设计}{\quad Control Zone shutdown and deletion process design}
\label{fig:cz_create_start}
\end{figure}
...
\begin{figure}[H]
    ...
    \bicaption{\quad Control Zone更新过程设计}{\quad Control Zone update process design}
    \label{fig:cz_update}
\end{figure}
