...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
      ...
      \begin{subfigure}[b]{0.32\textwidth}
        ...
        \label{fig:memcached_response}
      \end{subfigure}
    \bicaption{\quad 混部场景下响应度优先内核对LC应用服务性能的保障效果}{\quad Effectiveness of responsiveness-first kernel for LC application QoS guarantee in co-location deployment scenarios}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \bicaption{\quad 混部场景下吞吐量优先内核对BE应用服务性能的保障效果}{\quad Effectiveness of throughput-first kernel for BE application QoS guarantee in co-location deployment scenarios}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \bicaption{\quad 混部场景下吞吐量优先内核对BE应用运行时间的影响}{\quad Impact of throughput-first kernel on BE application runtime in co-location deployment scenarios}
...
\bicaption{\quad 混部场景下CPU感知调度策略对LC应用服务性能的保障效果}{\quad Effectiveness of CPU-aware scheduling policy for LC application QoS guarantee in co-location deployment scenarios}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\bicaption{\quad 不同应用混部场景下的虚拟机总CPU利用率}{\quad 
Total CPU utilization of virtual machines in co-location scenarios with different applications}
\label{fig:cpu_usage}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\bicaption{\quad SMT混部场景下CPU感知调度策略对LC应用服务性能的保障效果}{\quad Effectiveness of CPU-aware scheduling policy for LC application QoS guarantee in SMT co-location scenarios}
